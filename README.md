...
## CHECKLIST
- [ ] El diseño del front-end se adapta a lo planteado en el prototipo.
- [ ] La aplicación es totalmente responsive. Si algún componente no se visualiza adecuadamente en la versión móvil, se ha eliminado. En la versión de escritorio, los componentes no quedan desproporcionados con respecto al viewport.
- [ ] Se ha utilizado un framework de diseño y desarrollo de front-end como Bootstrap o Material, por ejemplo.
...
- [ ] Se utilizan modales en lugar de alerts o popups.
- [ ] Si se ha utilizado una plantilla/template en alguna parte del front-end, se referencia correctamente en el código y en la documentación.
- [ ] En el desarrollo se utilizan los elementos de programación propios del lenguaje escogido (por ejemplo, servicios, componentes, etc.).
- [ ] Se ha definido un routing correcto en la aplicación.
- [ ] Todas las vistas tienen botones/enlaces para poder volver al punto/a la vista anterior.
...
### API
- [ ] Se ha realizado la identificación de los recursos que utiliza la aplicación, y para cada uno se han implementado los métodos REST adecuados.
- [ ] Se han añadido los métodos adicionales necesarios para el correcto funcionamiento de la aplicación.
- [ ] Los métodos están lo más desacoplados posibles entre sí, y con respecto a la capa de acceso a datos.
...
- [ ] Se han identificado y documentado las limitaciones de la aplicación.
- [ ] Se han identificado y documentado los puntos de mejora de la aplicación.
...
- [ ] Se ha realizado el testing de front, back y API.
...
- [ ] Las pruebas se han realizado con éxito.
