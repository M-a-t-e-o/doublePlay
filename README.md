...
- [x] Se ha revisado el API frente a códigos de conducta en el diseño y desarrollo para buenas API.
...
- [x] Todo el código está correctamente documentado. Como mínimo, todos los ficheros tienen una cabecera identificativa, y las funciones un comentario con lo que hacen.
- [x] Se ha documentado la justificación y utilización de todos los paquetes identificados en el packages.json
...
- [x] Se han identificado y documentado las live URL para la aplicación y la documentación del API (Swagger).
